...
export const scenes = [
  {
    ...
    cast:[p(assets.characters.mashiro.checkRecords, 50,100,40)], speaker:'ナレーション',
    text:'出勤して、子どもたちが登園してくる前。\nましろは昨日の記録を確認していた。'
  },
  {
    id:'scene01-02', sceneNo:1, sceneLabel:'場面①　朝・記録整理',
    background:assets.backgrounds.recordMorning, cast:[p(assets.characters.mashiro.checkRecords,50,100,40)],
  ...
  },
  {
    ...
    background:assets.backgrounds.recordMorning, cast:[p(assets.characters.mashiro.reviewRecords,50,100,40)],
    speaker:'ましろ（心の声）', thought:true,
  ...
  },
  {
    ...
    background:assets.backgrounds.recordMorning, cast:[p(assets.characters.mashiro.talkChizuMorning,34,100,34),p(assets.characters.chizu.talkMorning,68,100,34)],
